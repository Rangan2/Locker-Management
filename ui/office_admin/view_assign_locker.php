                        ...
                        <tr>
                           <td width="12%" class="featureHeader" style="padding-top: 2em">
                            ...
                            <td width="10%" class="featureHeader" align="center" style="padding-top: 2em; color: #5D6D7E;">
                              Office</td>
                           <td width="20%" class="featureHeader"><select class="form-control" id="office" name="office" onchange="search_assign_floor()" style="width: 9em;">
                           ...
                           <td width="20%" class="featureHeader"><div id="showFloor"><?php include "search_floor.php";?></div></td>
                            <td width="12%" align="center" class="featureHeader" style="padding-top: 2em;  color: #5D6D7E">
                              Locker Number</td>
                <td width="20%"><input type="txt" style="width: 100%" class="form-control" id="locker_number" name="locker_number" onkeyup="search_assign_locker()">
                </td>
                 <tr>
            <td height="30" align="center" colspan="7"><div id="showList"><?php include "search_assign_locker.php";?></div></td>
          </tr>
                        </tr>
                    </table>
                 </div>
