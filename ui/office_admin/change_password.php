...
if(isset($_POST['Submit']))
{
   ...
   $pass_sql = "select * from office_admin_credentials_master where email_id='$_SESSION[email_id]'";
   ...
   {
      $update_password = "update office_admin_credentials_master set password='$new_pass' where email_id='$_SESSION[email_id]'";
