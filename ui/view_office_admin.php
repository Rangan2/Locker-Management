                  ...
                  <div class="col-lg-9" style="margin-top: 1.5em;">
                     <table class="table table-hover table-responsive table-hover features" width="90%" align="center">
                        ...
                        <tr class="viewOfficeTabHeader">
                           ...
                           <?php
                              $office_admin_sql = "select * from office_admin_credentials_master credentials, office_master office, office_admin_assigned_floor_number assignedFloor, floor_master floor  where credentials.added_by = '$_SESSION[user_id]' and credentials.office_id = office.office_id and credentials.credential_id = assignedFloor.credential_id and assignedFloor.floor_id = floor.floor_id";
                             // echo $office_admin_sql;exit;
                        ...
                        <tr>
                           ...
                           <td align="default"><?php echo $office_admin_res['office_location'];?>                           </td>
                           <td align="center"><?php echo $office_admin_res['floor_number'];?>                           </td>
                           <td align="center"><?php echo $office_admin_res['admin_name'];?>                           </td>
                           <td align="center"><?php echo $office_admin_res['email_id'];?>                           </td>
                           <td align="center">
                              <?php
                                 if($office_admin_res['assign_floor_status'] == 1 )
                                 {
                                 ?>
                              <a href="view_office_admin.php?status=<?php echo base64_encode(0);?>&office=<?php echo base64_encode($office_admin_res['credential_id']);?>&assign_floor=<?php echo base64_encode($office_admin_res['assign_floor_id']);?>">
                              ...
                              <?php
                                 ...
                                 ?>
                              <a href="view_office_admin.php?status=<?php echo base64_encode(1);?>&office=<?php echo base64_encode($office_admin_res['credential_id']);?>&assign_floor=<?php echo base64_encode($office_admin_res['assign_floor_id']);?>">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <select class="form-control" id="officeloc" name="officeloc" onChange="chk_floor()">
                                                   ...
                                                   <?php
                                                      ...
                                                      {
                                                      ?>
                                                   <option value="<?php echo $location_res['office_id'];?>" <?php if( $office_admin_res['office_id'] == $location_res['office_id']){ echo "selected";}?>><?php echo $location_res['office_location'];?></option>
                                                   <?php
                                                      }
                                                         ?>
                                                </select>
                           ...
                           <td width="7%" colspan="2" align="center">
                              <table  width="100%" border="0" align="right" style="border:0px solid #ccc; background-color: #FC4778; border-radius: 5px ;margin-left: 2em; cursor: pointer; color: #fff; box-shadow: 2px 2px 2px #c4c4c4;" >
                                 <tr height="25px">
                                    <td align="center" onClick="deleteFunc('view_office_admin.php?Delete=<?php echo base64_encode($office_admin_res['credential_id']);?>&Dfloor=<?php echo base64_encode($office_admin_res['assign_floor_id']);?>');">Delete</td>
                                 </tr>
                              </table>
                           </td>
                        </tr>
