...
<table width="100%" border="0">
  <tr>
    <td align="right"><table width="100%" border="0" align="center">
      <tr>
        <td width="41%" align="center" class="dashboard_header_coompany_name"><?php echo $company_name_res['company_name'];?></td>
        <td width="39%">&nbsp;</td>
        ...
        <td height="20" align="center" valign="middle"><table width="80%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="59%" align="center"><table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <?php
						$sql = "select * from menu_master where company_id='$_SESSION[company_id]' and menu_status=1";
						$rec = mysql_query($sql);
