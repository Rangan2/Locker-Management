...
if(isset($_POST['Submit']))
{
	...
	$pass_sql = "select * from office_admin_credentials_master where credential_id='$_SESSION[admin_id]'";
	...
	{
		$update_password = "update office_admin_credentials_master set password='$new_pass' where credential_id='$_SESSION[admin_id]'";
