        ...
        <td align="center"><table width="80%" border="0" cellpadding="0" cellspacing="0" class="dashboard_inner_tab">
		  ...
		  <?php
		  	if(isset($_GET['menu_id']))
			{
				...
				$menu_sql = "select * from menu_master where company_id = $_SESSION[company_id] and menu_status = 1 and menu_parent = $menu_id";
			}else{
		  		$menu_sql = "select * from menu_master where company_id = $_SESSION[company_id] and menu_status = 1 and menu_parent = 0";
			}
			...
			{
		  ?>
            <td align="center"><table width="250" border="0" cellpadding="0" cellspacing="0" class="dashboard_all_menu">
              <tr>
                <td>&nbsp;</td>
              </tr>
              <tr>
