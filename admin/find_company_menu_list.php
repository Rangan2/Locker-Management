<?php
	...
	$menu_fetch_sql = "select * from menu_master";
...
<table width="100%" border="0">
  ...
  <?php
	  	...
	  	while($menu_fetch_res = mysql_fetch_assoc($menu_fetch_rec))
		{
			...
			$parent_menu_fetch_sql = "select * from menu_master where menu_id = $menu_fetch_res[menu_parent]";
  ...
  <tr class="list_dyn_row" <?php echo $bg;?>>
    ...
    <td height="30" align="center"><span style="cursor:pointer">
      <?php
			...
			{
		?>
      <a href="company_menu.php?status=<?php echo base64_encode(0);?>&amp;menu=<?php echo base64_encode($menu_fetch_res['menu_id']);?>"><img src="../images/green.gif" width="24" height="24" /></a>
      <?php
			}else{
		?>
      <a href="company_menu.php?status=<?php echo base64_encode(1);?>&amp;menu=<?php echo base64_encode($menu_fetch_res['menu_id']);?>"><img src="../images/red.gif" width="24" height="24" /></a>
      <?php
			}
		?>
    </span></td>
    <td align="center" style="cursor:pointer"><table width="100%" border="0">
      <tr>
        <td width="38%" height="30" align="right"><a href="<?php echo "company_menu.php?Emenu=".base64_encode($menu_fetch_res['menu_id']);?>"><img src="../images/edit.gif" width="25" height="25" /></a></td>
        <td width="26%">&nbsp;</td>
        <td width="36%" align="left" onClick="deleteFunc('<?php echo 'company_menu.php?delMenu='.base64_encode($menu_fetch_res['menu_id']);?>')"><img src="../images/del.gif" width="25" height="25" /></td>
      </tr>
    </table></td>
  </tr>
  <?php
