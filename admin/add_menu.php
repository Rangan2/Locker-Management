...
session_start();
	...
	if(isset($_POST['Submit']))
	{
		...
		if($_POST['Submit'] == "Enter")
		{
			...
			$update_menu_sql = "update site_admin_menu_master set menu_name = '$menu_name', menu_link = '$menu_link', menu_parent = '$menu_parent' where menu_id = '$menu_id'";	
...
if(isset($_GET['menu']))
{
	...
	$menu_status_update_sql = "update site_admin_menu_master set menu_status = '$status' where menu_id = '$menu_id'";
...
if(isset($_GET['delMenu']))
{
	...
	$del_menu_sql = "delete from site_admin_menu_master where menu_id = '$menu_id'";
...
{
	$menu_id = base64_decode($_GET['Emenu']);
	$menu_update_fetch_sql = "select * from site_admin_menu_master where menu_id = '$menu_id'";
  ...
  ?>
      ...
      <tr>
        <td height="30" align="center"><table width="80%" border="0">
          ...
          <tr>
            <td height="30" align="center"><div id="showList"><?php include "find_menu_list.php";?></div></td>
          </tr>
        </table></td>
      </tr>
      <?php
